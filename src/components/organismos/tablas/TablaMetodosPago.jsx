...
export function TablaMetodosPago({
  ...
  function eliminar(p) {
    if (p.delete_update === false) {
      toast.error(
        "Acción no permitida: Los métodos de pago marcados como default son obligatorios para el funcionamiento del sistema. No se puede eliminar",
      );
      return;
    }
    Swal.fire({
  ...
  function editar(data) {
    if (data.delete_update === false) {
      toast.error(
        "Acción no permitida: Los métodos de pago marcados como default son obligatorios para el funcionamiento del sistema. No se puede editar",
      );
      return;
    }
