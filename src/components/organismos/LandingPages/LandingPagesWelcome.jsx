      ...
      <ContentSection>
        <SubContentSection>
          <LeftSection className="left-section">
            ...
            <MainTitle>
              SoftCreate <span>POS</span>
            </MainTitle>

            <AuthorText>
              Arquitectura y desarrollo por{" "}
              <strong>Ing. Johan Camilo Calderón Álvarez</strong>
            </AuthorText>
            ...
            <FeaturesList>
              <Step>
                <IconPlaceholder>
                  <img
                    src="https://i.ibb.co/HCF7jnx/escaparate.png"
                    alt="Gestión"
                  />
                </IconPlaceholder>
                <Text>
                  ...
                  <Description>
                    Controla sucursales, inventarios y ventas en tiempo real con
              ...
              <Step>
                <IconPlaceholder>
                  <img
                    src="https://i.ibb.co/MV6xZz4/franquicia.png"
                    alt="Escalabilidad"
                  />
                </IconPlaceholder>
                <Text>
                  ...
                  <Description>
                    Automatiza tareas operativas y centraliza la información de
              ...
              <Step>
                <IconPlaceholder>
                  <img
                    src="https://i.ibb.co/3dZfQzF/caja-registradora.png"
                    alt="Seguridad"
                  />
                </IconPlaceholder>
                <Text>
                  ...
                  <Description>
                    Arquitectura moderna diseñada para mantener tus datos
                    protegidos y siempre accesibles.
                  </Description>
                </Text>
              </Step>
            </FeaturesList>
...
const MockupBackground = styled.div`
  ...
  &::before {
    ...
    background: radial-gradient(
      circle,
      ${({ theme }) => theme.carouselColor}30 0%,
      transparent 70%
    );
    position: absolute;
    z-index: 0;
